...
class OnSiteController extends CrawlController  {
	...
	public function addedOnSiteDataTable($subtyp, $description, $crawlId, $cmpCrawlId) {
		$data = UrlAlert::addedOnSiteUrls($crawlId, $cmpCrawlId, $subtyp, $description);
		$filename = "{$subtyp}-{$description}-{$crawlId}-{$cmpCrawlId}.csv";
